/*Ejercicio 14  Crear un documento con el nombre ej14.js
	Declarar una variable nombre con tu nombre
	Declarar una variable saludo con el siguiente valor: Bienvenido/a
...
console.log(mensaje + ' ' + nombre + ' ' + finDeSaludo);
